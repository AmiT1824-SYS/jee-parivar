...
/**
 * ============================================================================
 * 🚀 JEE PARIVAR - ULTIMATE NTA EXAM ENGINE (v8.0 - PART 1)
 * ============================================================================
 * Features: Time-spent tracking per question, Real IIT Photos, 
 * Focus Mode, Planner, Backlogs, YouTube Auto-Search.
 * ============================================================================
 */
...
// ============================================================================
// 📦 2. BUILT-IN TEST DATA ARRAY (HUM ISKO PART 2 & 3 MEIN BHARENGE)
// ============================================================================
const JEE_ADV_2016_MEGA_TEST = [
  // PART 2 AUR PART 3 KE QUESTIONS YAHA AAYENGE
];
...
export default function JEEParivarUltimateLatexApp() {
  ...
  const [questionTimers, setQuestionTimers] = useState({}); // Tracking time spent per question by ID
  ...
  useEffect(() => {
    ...
    if (currentView === 'test' && timer > 0 && !scoreCard) {
      interval = setInterval(() => {
        ...
        // Tracking time spent per specific question ID
  ...
  const startTestFromLibrary = (test) => {
    if(!test.data || test.data.length === 0) {
      showToast("Test is empty! Please paste Part 2 JSON first.", "error");
      return;
    }
        ...
        <div className="flex flex-col h-screen overflow-hidden bg-slate-950">
          ...
          <header className="bg-slate-900 border-b border-slate-800 px-6 py-3 flex justify-between items-center shrink-0">
            ...
            <div className="flex items-center gap-4 shrink-0">
              {/* DISPLAYING TIME SPENT PER QUESTION LIVE */}
        ...
        <div className="min-h-screen p-6 md:p-10 max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            {testQuestions.map((q, idx) => {
              ...
              const timeSpentOnThisQ = questionTimers[q.id] || 0; // Fetching specific time tracked
              ...
              return (
                <div key={q.id} className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-xl relative overflow-hidden">
                  ...
                  <div className="mb-6 flex justify-between items-center border-b border-slate-800 pb-4">
                    ...
                    {/* DISPLAYING TIME SPENT PER QUESTION IN SOLUTIONS */}
